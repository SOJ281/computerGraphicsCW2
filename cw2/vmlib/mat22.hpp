...
{
	return Mat22f{ aLeft._00 * aRight._00 + aLeft._01 * aRight._10,
...
{
	return Vec2f{ aLeft._00 * aRight.x + aLeft._01 * aRight.y,
...
{
	return Mat22f{ (float)cos(aAngle), (float)-sin(aAngle), (float)sin(aAngle), (float)cos(aAngle) };
}
